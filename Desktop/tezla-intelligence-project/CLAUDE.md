...
- **⚠️ CONFLITO ABERTO — design**: o documento exige "predominantemente claro, sem fundo preto como padrão" (seção 17). Isso contradiz diretamente o sistema "Night Audit" (fundo quase-preto, tema escuro) construído nas sessões anteriores, que a usuária escolheu deliberadamente via processo de design. **Não alterar o CSS existente por causa disso sem confirmação explícita da usuária** — perguntado em 08/09/2026, aguardando resposta.
